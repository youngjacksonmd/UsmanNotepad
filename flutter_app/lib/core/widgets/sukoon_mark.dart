...
///
/// Two flowing paper strokes form a quiet, abstract S while the small amber
/// fold suggests a saved thought. The mark is drawn in code so it remains
/// sharp at every density and works without network or image assets.
...
class _SukoonMarkPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(card, paperPaint);
